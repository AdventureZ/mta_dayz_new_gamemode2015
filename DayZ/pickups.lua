...
{"Child Briefcase",1877,1,0,6},
{"Krysset Backpack",1881,1,0,0.5},
{"Painkiller",2709,3,0,7},
{"Empty Soda Cans",2673,0.5,0,12},
{"Scruffy Burgers",2675,0.5,0,12},
{"Grenade",342,1,0,0.01},
{"Revolver",348,1,90,0.4},
...
{"M4A1 CCO SD",356,1,90,2.4},
{"DMR",358,1,90,0.4},
{"Infrared Goggles",369,1,90,3},
{"Assault Pack (ACU)",3026,1,0,5},
{"Child Briefcase",1877,1,0,5},
{"Czech Backpack",1239,1,0,2}, 
{"Mountain Backpack",1878,1,0,2},
{"O.S Pack",1879,1,0,0.9},
{"LHT Ghillie Pack",1880,1,0,0.8},
{"Krysset Backpack",1881,1,0,0.7},
{"Anarchy Assault Pack",1882,1,0,0.5},
...
{"Firefighter Axe",339,1,90,1.5},
{"Pizza",1582,1,0,4},
{"Roadflare",324,1,90,5},
{"Milk",2856,1,0,4},
{"Assault Pack (ACU)",3026,1,0,6},
{"Coyote Backpack",1252,1,0,0.5},
{"O.S Pack",1879,1,0,0.5},
{"LHT Ghillie Pack",1880,1,0,0.6},
{"Anarchy Assault Pack",1882,1,0,0.5},
{"Radio Device",330,1,0,6},
...
{"Assault Pack (ACU)",3026,1,0,6},
{"Child Briefcase",1877,1,0,6},
{"Mountain Backpack",1878,1,0,3},
{"O.S Pack",1879,1,0,0.7},
{"LHT Ghillie Pack",1880,1,0,0.7},
{"Krysset Backpack",1881,1,0,0.7},
{"Anarchy Assault Pack",1882,1,0,0.7},
{"Painkiller",2709,3,0,7},
{"Empty Soda Cans",2673,0.5,0,12},
{"Scruffy Burgers",2675,0.5,0,12},
{"MP5A5",353,1,90,1.5},
...
elseif itemName == "Shotgun Ammo" then
	itemPlus = 7
elseif itemName == "M4A1 CCO SD" or itemName == "AK-47" or itemName == "Sniper Rifle" or itemName == "Shotgun" or itemName == "SPAZ-12 Combat Shotgun" or itemName == "Sawn-Off Shotgun" or itemName == "Heat-Seeking RPG" or itemName == "Rocket Launcher" or itemName == "Country Rifle" then
...
function refreshItemLoots ()
	...
	setTimer(refreshItemLootPoints1,gameplayVariables["itemrespawntimer"] ,1)
end
...
function refreshItemLootPoints ()
	...
	outputChatBox("#ff2200AVISO! #ffffff - SPAWNPOINTS FOR ITEMS WILL BE REFRESHED IN 1 MINUTE! BEWARE OF MASSIVE LAG!",getRootElement(),255,255,255,true)
	setServerPassword( "adventureEPOCH" )
	for i,player in ipairs(getElementsByType("player")) do
		kickPlayer ( player, "Respawn loot, aguarde alguns minutos para entrar." )
	end
...
function refreshItemLootPoints1 ()
	outputChatBox("#ff2200AVISO! #ffffff - SPAWNPOINTS FOR ITEMS WILL BE REFRESHED IN 1 MINUTE! BEWARE OF MASSIVE LAG!",getRootElement(),255,0,0,true)
	outputChatBox("#ff2200ATENÇÃO! #ffffff - O Respawns de Loot Começar Em 1 Minuto! Risco Ernome de Lag!",getRootElement(),255,0,0,true)
