...
policeSpawns = gameplayVariables["policespawns"]

bladeSpawns = gameplayVariables["bladespawns"]
...
kartSpawns = gameplayVariables["kartspawns"]
...
function spawnDayZVehicles()
	...
	for i,veh in ipairs(policeSpawns) do
		local x,y,z = veh[1],veh[2],veh[3]
		veh = createVehicle(597,x,y,z)
		vehCol = createColSphere(x,y,z,4)
		attachElements ( vehCol, veh, 0, 0, 0 )
		setElementData(vehCol,"parent",veh)
		setElementData(veh,"parent",vehCol)
		...
		setElementData(vehCol,"Engine_inVehicle",math.random(0,engine))
		--vehicle_indentifikation
		setElementData(vehCol,"spawn",{597,x,y,z})
		--others
		setElementData(vehCol,"fuel",10)
	end
	for i,veh in ipairs(bladeSpawns) do
		local x,y,z = veh[1],veh[2],veh[3]
		veh = createVehicle(536,x,y,z)
		vehCol = createColSphere(x,y,z,4)
		attachElements ( vehCol, veh, 0, 0, 0 )
		setElementData(vehCol,"parent",veh)
		setElementData(veh,"parent",vehCol)
		...
		setElementData(vehCol,"Engine_inVehicle",math.random(0,engine))
		--vehicle_indentifikation
		setElementData(vehCol,"spawn",{536,x,y,z})
		--others
		setElementData(vehCol,"fuel",10)
	end
...
for i,veh in ipairs(kartSpawns) do
		local x,y,z = veh[1],veh[2],veh[3]
		veh = createVehicle(571,x,y,z)
		vehCol = createColSphere(x,y,z,4)
		attachElements ( vehCol, veh, 0, 0, 0 )
		setElementData(vehCol,"parent",veh)
		setElementData(veh,"parent",vehCol)
		...
		setElementData(vehCol,"Engine_inVehicle",math.random(0,engine))
		--vehicle_indentifikation
		setElementData(vehCol,"spawn",{571,x,y,z})
		--others
		setElementData(vehCol,"fuel",10)
	end	
		...
		for i,veh in ipairs(taxiSpanws) do
		local x,y,z = veh[1],veh[2],veh[3]
...
--you enter /destroyall in the chat box or destroyall in the game console.
addCommandHandler("dall", allvehiclesaredoomed)
...
function notifyAboutExplosion()
    ...
    setTimer(respawnDayZVehicle,14400000,1,id,x,y,z,source,col,getElementData(col,"MAX_Slots"))
...
setTimer(checkVehicleInWater,14400000,0)
--1800000
...
outputChatBox("Ser For Dirigi Nao Beba. Chame Um Taxi!",source)
end
